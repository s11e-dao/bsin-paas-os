...
export default {
  ...
  define: {
    ...
    'process.env.subtitle': 's11e network web3品牌',
    'process.env.paasDescription': 'BsinPaaS一站式开发平台',
    ...
    'process.env.bsinFileUploadUrl': 'http://127.0.0.1:9195/bsinFileUpload', // IPFS存储且OSS备份
