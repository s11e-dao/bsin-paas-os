import { addGlobalUncaughtErrorHandler, addErrorHandler, removeGlobalUncaughtErrorHandler } from 'qiankun';
...
addGlobalUncaughtErrorHandler((event: any) => {
  ...
  if (
    ...
    console.log(window.localStorage.getItem('bsin-microAppMountStatus') !== '3');
...
export const qiankun = () => {
   return getPublishApps({}).then((res:any) => {
    if (res && res.code === 0) {
