...
public class WxPortalController {
  ...
  @Autowired private WxPlatformMsgHandlerBiz wxPlatformMsgHandlerBiz;
  @Autowired private WxPlatformSubscribeHandlerBiz wxPlatformSubscribeHandlerBiz;
  @Autowired private WxPlatformClickHandlerBiz wxPlatformClickHandlerBiz;
  @Autowired private WxPlatformViewHandlerBiz wxPlatformViewHandlerBiz;
  ...
  public String authGet(
    ...
    if (StringUtils.equals(wxPlatform.getType(), WxPlatformType.MP.getType())) {
      ...
      WxMpService wxService = bsinWxMpServiceUtil.getWxMpService(config, redisConfig);
