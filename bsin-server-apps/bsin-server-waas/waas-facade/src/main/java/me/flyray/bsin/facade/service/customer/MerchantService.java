...
public interface MerchantService {
     ...
     * @
     */
    BsinResultEntity<Merchant> editMerchant(Merchant merchant) ;
     ...
     * @
     */
    BsinResultEntity<Merchant> deleteMerchant(String merchantId) ;
     ...
     * @
     */
    BsinResultEntity<Page<Merchant>> pageList(MerchantDTO merchant) ;
