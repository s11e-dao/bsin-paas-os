package me.flyray.bsin.mqtt.domain.model;
...
import me.flyray.bsin.mqtt.domain.error.IErrorInfo;
...
public class ResponseResult<T> {
  ...
  public static ResponseResult success() {
    return ResponseResult.builder().code(0).message(MESSAGE_SUCCESS).build();
  }
