...
type SettingsStateKeys = 'base' | 'modelSetting' | 'toChat'
type SettingsState = {
...
export default ({
  ...
  const renderChildren = () => {
    ...
    switch (selectKey) {
      case 'base':
        return <BaseView copilotInfo={currentRecord} />
      case 'modelSetting':
        return <ModelSetting copilotInfo={currentRecord} />
      case 'toChat':
        return (
          <ChatWithCopilot
