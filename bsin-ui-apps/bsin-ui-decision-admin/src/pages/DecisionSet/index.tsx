...
import { listMock } from './dexisionSetMock';
import CanvasComp from './components/CanvasComp/index';
const canvasData = {
  title: '规则名称1',
    ...
    <div key={record.roleId}>
      ...
      <a
        onClick={() => {
          ...
          // 点击规则设计，列表默认显示为true，
          // 点击这里，列表隐藏，画布展示
          // TODO 传入record.roleId，请求到具体一项数据，传入CanvasComp组件
      ...
      {isListModal ? (
        <div>
          ...
          <ProTable<AppColumnsItem>
            ...
            scroll={{ x: 900 }}
            bordered
            headerTitle={<TableTitle title="决策集" />}
            columns={columns}
            // 请求数据
