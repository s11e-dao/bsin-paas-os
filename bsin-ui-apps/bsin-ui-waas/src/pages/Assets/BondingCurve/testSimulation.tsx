...
const TestSimulation: React.FC = () => {
    ...
    const handleTest = () => {
        try {
            ...
            console.log('基础推荐参数:', basicRecommendations);
            ...
            console.log('完整推荐参数:', completeRecommendations);

            // 测试参数优化
            const optimizations = optimizeSimulationParams(testParams);
            console.log('参数优化结果:', optimizations);
    ...
    return (
        <Card title="仿真功能测试" style={{ margin: '20px' }}>
            ...
            <p style={{ marginTop: '10px', color: '#666' }}>
                点击按钮测试仿真功能，包括参数验证、推荐计算、优化功能和仿真计算，结果将输出到控制台
            </p>
        </Card>
    );
};
