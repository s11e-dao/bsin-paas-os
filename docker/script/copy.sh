...
cp -rvf ../bsin-targe-gateway-admin/target/targe-gateway-admin-3.0.0-SNAPSHOT.jar ./bsin-paas-os/targe-gateway-admin/jar/targe-gateway-admin-3.0.0-SNAPSHOT.jar

echo "5.2 begin copy targe-gateway jar "
cp -rvf ../bsin-targe-gateway/target/targe-gateway-3.0.0-SNAPSHOT.jar ./bsin-paas-os/targe-gateway/jar/targe-gateway-3.0.0-SNAPSHOT.jar
