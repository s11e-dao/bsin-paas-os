...
# 启动基础环境（必须）
middleware(){
	docker-compose up -d bsin-mysql-3.0 bsin-redis-3.0 bsin-nacos-standalone-3.0 bsin-emqx-3.0 bsin-elasticsearch-3.0 bsin-elasticsearch-3.0-kibana bsin-elasticsearch-3.0-head #bsin-nginx-3.0 #bsin-rabbitmq-3.0 bsin-milvus-3.0
}
